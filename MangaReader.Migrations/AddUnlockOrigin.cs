...
[Migration("20260102092831_AddUnlockOrigin")]
public class AddUnlockOrigin : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.AddColumn<int>("Origin", "UserUnlockedTitle", "int", (bool?)null, (int?)null, false, (string)null, false, (object)0, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
		migrationBuilder.AddColumn<int>("Origin", "UserUnlockedDecoration", "int", (bool?)null, (int?)null, false, (string)null, false, (object)0, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("Origin", "UserUnlockedTitle", (string)null);
		migrationBuilder.DropColumn("Origin", "UserUnlockedDecoration", (string)null);
	}
	...
	protected override void BuildTargetModel(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity("MangaReader.Models.ChangelogEntry", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			RelationalPropertyBuilderExtensions.HasColumnType<string>(b.Property<string>("Content").IsRequired(true), "longtext");
			...
			RelationalEntityTypeBuilderExtensions.ToTable(b, "ChangelogEntries");
		});
		modelBuilder.Entity("MangaReader.Models.Chapter", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			RelationalPropertyBuilderExtensions.HasColumnType<string>(b.Property<string>("Title").HasMaxLength(300), "varchar(300)");
		...
		modelBuilder.Entity("MangaReader.Models.ChapterComment", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			RelationalPropertyBuilderExtensions.HasColumnType<int?>(b.Property<int?>("RepliedToUserId"), "int");
			...
			b.HasIndex(new string[1] { "RepliedToUserId" });
		...
		modelBuilder.Entity("MangaReader.Models.Manga", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			RelationalPropertyBuilderExtensions.HasColumnType<int>(b.Property<int>("Id").ValueGeneratedOnAdd(), "int");
			MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn<int>(b.Property<int>("Id"));
			RelationalPropertyBuilderExtensions.HasColumnType<int?>(b.Property<int?>("AniListId"), "int");
			...
			RelationalPropertyBuilderExtensions.HasColumnType<bool>(b.Property<bool>("IsSuggestive"), "tinyint(1)");
		...
		modelBuilder.Entity("MangaReader.Models.User", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			RelationalPropertyBuilderExtensions.HasColumnType<DateTime>(b.Property<DateTime>("CreatedAt"), "datetime(6)");
			RelationalPropertyBuilderExtensions.HasColumnType<string>(b.Property<string>("CustomAccentColor"), "longtext");
			RelationalPropertyBuilderExtensions.HasColumnType<string>(b.Property<string>("CustomBackgroundUrl"), "longtext");
			RelationalPropertyBuilderExtensions.HasColumnType<string>(b.Property<string>("CustomCss"), "longtext");
			RelationalPropertyBuilderExtensions.HasColumnType<string>(b.Property<string>("CustomPrimaryColor"), "longtext");
			RelationalPropertyBuilderExtensions.HasColumnType<bool>(b.Property<bool>("DisableFeaturedBanners"), "tinyint(1)");
			...
			RelationalPropertyBuilderExtensions.HasColumnType<bool>(b.Property<bool>("FollowChangelog"), "tinyint(1)");
			RelationalPropertyBuilderExtensions.HasColumnType<bool>(b.Property<bool>("HideReadingList"), "tinyint(1)");
			RelationalPropertyBuilderExtensions.HasColumnType<bool>(b.Property<bool>("IgnoreSuggestiveWarnings"), "tinyint(1)");
			...
			RelationalPropertyBuilderExtensions.HasColumnType<bool>(b.Property<bool>("ShowAllFeaturedAsCovers"), "tinyint(1)");
			RelationalPropertyBuilderExtensions.HasColumnType<double?>(b.Property<double?>("SiteOpacity"), "double");
			RelationalPropertyBuilderExtensions.HasColumnType<DateTime>(b.Property<DateTime>("UpdatedAt"), "datetime(6)");
		...
		modelBuilder.Entity("MangaReader.Models.UserUnlockedDecoration", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			RelationalPropertyBuilderExtensions.HasColumnType<int>(b.Property<int>("Origin"), "int");
			...
			b.HasIndex(new string[2] { "UserId", "DecorationId" }).IsUnique(true);
			RelationalEntityTypeBuilderExtensions.ToTable(b, "UserUnlockedDecoration", (string)null);
		});
		modelBuilder.Entity("MangaReader.Models.UserUnlockedTitle", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			b.HasIndex(new string[2] { "UserId", "TitleId" }).IsUnique(true);
			RelationalEntityTypeBuilderExtensions.ToTable(b, "UserUnlockedTitle", (string)null);
		});
		modelBuilder.Entity("MangaReader.Models.Chapter", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
		...
		modelBuilder.Entity("MangaReader.Models.ChapterComment", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			b.HasOne("MangaReader.Models.User", "RepliedToUser").WithMany((string)null).HasForeignKey(new string[1] { "RepliedToUserId" })
