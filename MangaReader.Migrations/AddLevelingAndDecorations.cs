...
[Migration("20251229134954_AddLevelingAndDecorations")]
public class AddLevelingAndDecorations : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateTable("PfpDecorations", delegate(ColumnsBuilder table)
		{
			...
			return new
			{
				Id = id,
				Name = name,
				ImageUrl = table.Column<string>("varchar(500)", (bool?)null, num, false, (string)null, false, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null).Annotation("MySql:CharSet", (object)"utf8mb4"),
				...
				IsAnimated = table.Column<bool>("tinyint(1)", (bool?)null, (int?)null, false, (string)null, false, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null),
		...
		{
			table.PrimaryKey("PK_PfpDecorations", x => (object)x.Id);
		}, (string)null).Annotation("MySql:CharSet", (object)"utf8mb4");
		migrationBuilder.AddColumn<int>("XP", "Users", "int", (bool?)null, (int?)null, false, (string)null, false, (object)0, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
		migrationBuilder.AddColumn<int>("Level", "Users", "int", (bool?)null, (int?)null, false, (string)null, false, (object)1, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
		migrationBuilder.AddColumn<int>("EquippedDecorationId", "Users", "int", (bool?)null, (int?)null, false, (string)null, true, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null);
		migrationBuilder.CreateTable("ChapterViews", (ColumnsBuilder table) => new
		{
			...
			ChapterId = table.Column<int>("int", (bool?)null, (int?)null, false, (string)null, false, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null),
			ViewedAt = table.Column<DateTime>("datetime(6)", (bool?)null, (int?)null, false, (string)null, false, (object)null, (string)null, (string)null, (bool?)null, (string)null, (string)null, (int?)null, (int?)null, (bool?)null)
		}, (string)null, table =>
		{
			table.PrimaryKey("PK_ChapterViews", x => (object)x.Id);
			table.ForeignKey("FK_ChapterViews_Chapters_ChapterId", x => (object)x.ChapterId, "Chapters", "Id", (string)null, (ReferentialAction)0, (ReferentialAction)2);
			table.ForeignKey("FK_ChapterViews_Users_UserId", x => (object)x.UserId, "Users", "Id", (string)null, (ReferentialAction)0, (ReferentialAction)2);
		}, (string)null).Annotation("MySql:CharSet", (object)"utf8mb4");
		migrationBuilder.InsertData("PfpDecorations", new string[6] { "Id", "CreatedAt", "ImageUrl", "IsAnimated", "LevelRequirement", "Name" }, new object[6]
		{
			1,
			DateTime.UtcNow,
			"https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJqZ3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/3o7TKMGV9mGfVf8kEw/giphy.gif",
			true,
			1,
			"Glow Ring"
		}, (string)null);
		migrationBuilder.CreateIndex("IX_ChapterViews_ChapterId", "ChapterViews", "ChapterId", (string)null, false, (string)null, (bool[])null);
		migrationBuilder.CreateIndex("IX_ChapterViews_UserId_ChapterId", "ChapterViews", new string[2] { "UserId", "ChapterId" }, (string)null, true, (string)null, (bool[])null);
		migrationBuilder.CreateIndex("IX_Users_EquippedDecorationId", "Users", "EquippedDecorationId", (string)null, false, (string)null, (bool[])null);
		migrationBuilder.AddForeignKey("FK_Users_PfpDecorations_EquippedDecorationId", "Users", "EquippedDecorationId", "PfpDecorations", (string)null, (string)null, "Id", (ReferentialAction)0, (ReferentialAction)0);
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropForeignKey("FK_Users_PfpDecorations_EquippedDecorationId", "Users", (string)null);
		migrationBuilder.DropTable("ChapterViews", (string)null);
		migrationBuilder.DropTable("PfpDecorations", (string)null);
		migrationBuilder.DropColumn("XP", "Users", (string)null);
		migrationBuilder.DropColumn("Level", "Users", (string)null);
		migrationBuilder.DropColumn("EquippedDecorationId", "Users", (string)null);
	}
	...
	protected override void BuildTargetModel(ModelBuilder modelBuilder)
	{
		...
		modelBuilder.Entity("MangaReader.Models.PfpDecoration", (Action<EntityTypeBuilder>)delegate(EntityTypeBuilder b)
		{
			...
			b.HasData(new object[1]
			{
				...
				{
					Id = 1,
					CreatedAt = new DateTime(2025, 12, 29, 13, 49, 53, 809, DateTimeKind.Utc).AddTicks(2918L),
