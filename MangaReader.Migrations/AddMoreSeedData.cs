...
public class AddMoreSeedData : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.UpdateData("PfpDecorations", "Id", (object)1, new string[2] { "CreatedAt", "ImageUrl" }, new object[2]
		{
			new DateTime(2025, 12, 29, 0, 0, 0, 0, DateTimeKind.Utc),
			"https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJqZ3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/3o7TKMGV9mGfVf8kEw/giphy.gif"
		}, (string)null);
		migrationBuilder.InsertData("PfpDecorations", new string[6] { "Id", "CreatedAt", "ImageUrl", "IsAnimated", "LevelRequirement", "Name" }, new object[6]
		{
			2,
			new DateTime(2025, 12, 29, 0, 0, 0, 0, DateTimeKind.Utc),
			"https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHJqZ3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4Z3R4JmVwPXYxX2ludGVybmFsX2dpZl9ieV9pZCZjdD1z/26hpKz786Cq0Y/giphy.gif",
			true,
			5,
			"Golden Sparkle"
		}, (string)null);
	...
	{
		migrationBuilder.DeleteData("PfpDecorations", "Id", (object)2, (string)null);
		migrationBuilder.UpdateData("PfpDecorations", "Id", (object)1, new string[2] { "CreatedAt", "ImageUrl" }, new object[2]
		{
			new DateTime(2025, 12, 29, 13, 54, 27, 524, DateTimeKind.Utc).AddTicks(2794L),
